    ...
    public class EventCatalogSeed
    {
        ...
        private static IEnumerable<EventItem> GetEventCatalogItems()
        {
            ...
            {                
                ...
                new EventItem { EventLocationId = 3, EventCategoryId = 2, EventOrganizerId = 2, Description = "Show off your knowledge skills", Name = "Trivia Night",  EventAddress = "Statesman Arena", Date =Convert.ToDateTime("09/02/2023"), StartTime=Convert.ToDateTime("8:30PM"), EndTime=Convert.ToDateTime("10:30PM"), Price = 10.5M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/14" },
                new EventItem { EventLocationId = 3, EventCategoryId = 1, EventOrganizerId = 3, Description = "Ring in the new year!", Name = "New Years Eve Countdown", EventAddress = "Country Club", Date =Convert.ToDateTime("12/31/2023"), StartTime=Convert.ToDateTime("9:00PM"), EndTime=Convert.ToDateTime("12:00AM"),Price = 30M, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/15" }
            };
        }
